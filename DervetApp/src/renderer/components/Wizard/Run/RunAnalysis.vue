<template>
  <div>
    <div class="form-horizontal form-buffer">
      ...
      <div class="col-md-12 text-center center-error-vertically" v-else-if="dervetRunError">
...
<script>
  ...
  import { LOG_FILE } from '@/service/ProjectDto';
  ...
  export default {
    ...
    computed: {
      dervetRunError() {
        return this.$store.state.Application.dervetRunError === true;
      },
      results() {
