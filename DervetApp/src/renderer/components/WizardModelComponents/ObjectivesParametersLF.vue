  ...
  <div>
    ...
    <div class="form-horizontal form-buffer">
      ...
      <timeseries-data-upload
        chart-name="tsLfEnergyOptionUpChartUploaded"
        @click="receiveRemove"
        :data-exists="tsData('tsLfEnergyOptionUp').data.length !== 0"
        :DataModel="metadata.tsLfEnergyOptionUp.DataModel"
        :data-name="metadata.tsLfEnergyOptionUp.displayName"
        :data-time-series="tsData('tsLfEnergyOptionUp')"
        :errorMessage="getErrorMsgTS('tsLfEnergyOptionUp')"
        :isInvalid="submitted && tsData('tsLfEnergyOptionUp').data.length === 0"
        @input="receiveUseExisting"
        :key="childKey('tsLfEnergyOptionUp')"
        object-name="tsLfEnergyOptionUp"
        @uploaded="receiveTimeseriesData"
      />

      <timeseries-data-upload
        chart-name="tsLfEnergyOptionDownChartUploaded"
        @click="receiveRemove"
        :data-exists="tsData('tsLfEnergyOptionDown').data.length !== 0"
        :DataModel="metadata.tsLfEnergyOptionDown.DataModel"
        :data-name="metadata.tsLfEnergyOptionDown.displayName"
        :data-time-series="tsData('tsLfEnergyOptionDown')"
        :errorMessage="getErrorMsgTS('tsLfEnergyOptionDown')"
        :isInvalid="submitted && tsData('tsLfEnergyOptionDown').data.length === 0"
        @input="receiveUseExisting"
        :key="childKey('tsLfEnergyOptionDown')"
        object-name="tsLfEnergyOptionDown"
        @uploaded="receiveTimeseriesData"
      />
